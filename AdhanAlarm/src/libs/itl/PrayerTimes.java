...
public class PrayerTimes {
	...
	public class Prayer {
		...
		public void setHour(int aHour){hour = aHour;}
		public void setMinute(int aMinute){minute = aMinute;}
		public void setSecond(int aSecond){second = aSecond;}
		public void setIsExtreme(int aIsExtreme){isExtreme = aIsExtreme;}
		Prayer getPrayer(){
